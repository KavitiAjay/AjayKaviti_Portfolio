        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
          ...
          >
            <div>
              ...
              <div className="text-sm text-muted-foreground uppercase tracking-wider mt-1">Years Exp</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-5xl md:text-6xl font-bold">3</div>
              <div className="text-sm text-muted-foreground uppercase tracking-wider mt-1">Certifications</div>
            </div>
          </motion.div>
          ...
          >
            <a
              ...
              className="group p-4 border border-border hover:bg-primary hover:border-primary transition-all"
            >
            ...
            <a
              ...
              className="group flex items-center gap-2 px-5 py-4 bg-primary text-primary-foreground hover:opacity-90 transition-all"
            >
